<h2> 632 103
1805. Number of Different Integers in a String</h2><hr><div><p>You are given a string <code>word</code> that consists of digits and lowercase English letters.</p>
